test_that("visual: table with borders (simple)", {
  skip_if_not_installed("vdiffr")
  vdiffr::expect_doppelganger("table-simple", function() {
    grid.latex(
      "\\begin{array}{|c|c|}\\hline a & b \\\\ \\hline c & d \\\\ \\hline \\end{array}",
      fontsize = 20, render_mode = "path"
    )
  })
})
...
test_that("visual: complex formula", {
  ...
  vdiffr::expect_doppelganger("complex-formula", function() {
    grid.latex(paste0(
      ...
      "\\end{array}"
    ), fontsize = 16, render_mode = "path")
  })

  vdiffr::expect_doppelganger("complex-formula-typeface", function() {
    grid.latex(paste0(
      "\\begin{array}{l}",
      "  \\forall\\varepsilon\\in\\mathbb{R}_+^*\\ \\exists\\eta>0",
      "\\ |x-x_0|\\leq\\eta\\Longrightarrow|f(x)-f(x_0)|\\leq\\varepsilon\\\\",
      ...
      " = \\frac{(2n-1)!!}{2^{n+1}} \\sqrt{\\frac{\\pi}{a^{2n+1}}}\\\\",
      "\\end{array}"
    ), fontsize = 14, render_mode = "typeface")
  })
})
...
test_that("visual: table with multicolumn and borders", {
  ...
  vdiffr::expect_doppelganger("table-multicolumn", function() {
    grid.latex(paste0(
      ...
      "  \\hline",
      "\\end{array}"
    ), fontsize = 14, render_mode = "path")
  })

  vdiffr::expect_doppelganger("table-multicolumn-typeface", function() {
    grid.latex(paste0(
      "\\begin{array}{|c|c|c|c|}",
      "  \\hline",
      "  \\multicolumn{4}{|c|}{\\text{Table Head}}\\\\",
      ...
      "  \\hline",
      "\\end{array}"
    ), fontsize = 12, render_mode = "typeface")
  })
})
...
test_that("visual: overbrace and cancel", {
  ...
  vdiffr::expect_doppelganger("overbrace-underbrace-typeface", function() {
    grid.latex(
      "\\rlap{\\overbrace{\\phantom{1 + a + b + \\cdots + z}}^{\\text{total + 1}}}\n1 + \\underbrace{a + b + \\cdots + z}_{\\text{total}}",
      fontsize = 20, render_mode = "typeface"
    )
  })
  vdiffr::expect_doppelganger("cancel-variants-typeface", function() {
    grid.latex(
      "\\frac{a\\cancel{b}}{\\cancel{b}} = a;\n\\frac{a\\bcancel{b}}{\\bcancel{b}} = a;\n\\frac{a\\xcancel{b}}{\\xcancel{b}} = a;",
      fontsize = 20, render_mode = "typeface"
    )
...
test_that("visual: cases and split", {
  ...
  vdiffr::expect_doppelganger("cases", function() {
    grid.latex(paste0(
      ...
      "\\end{cases}"
    ), fontsize = 18, render_mode = "path")
  })

  vdiffr::expect_doppelganger("cases-typeface", function() {
    grid.latex(paste0(
      "P_{r-j}=\\begin{cases}",
      "0& \\text{if $r-j$ is odd},\\\\",
      "r!\\,(-1)^{(r-j)/2}& \\text{if $r-j$ is even}.",
      "\\end{cases}"
    ), fontsize = 18, render_mode = "typeface")
  })
})
...
test_that("visual: continued fraction", {
  ...
  vdiffr::expect_doppelganger("cfrac-typeface", function() {
    grid.latex(
      "\\cfrac{1}{\\sqrt{2}+\n\\cfrac{1}{\\sqrt{2}+\n\\cfrac{1}{\\sqrt{2}+\\dotsb\n}}}",
      fontsize = 20, render_mode = "typeface"
    )
