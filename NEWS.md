...
- Bug fix: a line break inside `\textbf{}`, `\textcolor{}{}` or any other text command lost that styling from the second line on, and could push following text outside the `\text{}` block.
