...
- **`"typeface"`** (default) draws glyphs as native text, so PDF and SVG
  ...
  their OTF files, with no system-wide install --- but this needs a
  device with the R \eqn{\geq} 4.3 glyph engine (`ragg`, `svglite`,
  `cairo_pdf`). On others, such as the base `pdf()` device, it falls back
