...
**gridmicrotex** renders LaTeX math in [base R plots](#base-graphics) and
as native R `grid` graphics objects, embedding the
[MicroTeX](https://github.com/NanoMichael/MicroTeX) C++ engine. For a grob,
the pipeline is:
