...
- Multiple math fonts (Latin Modern Math, STIX Two Math, Lete Sans Math, TeX Gyre DejaVu Math)
...
The package bundles Latin Modern Math (default), STIX Two Math,
Lete Sans Math, and TeX Gyre DejaVu Math.
