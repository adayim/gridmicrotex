...
- **Display math** --- a paragraph that is nothing but `$$…$$` --- gets
  ...
  unaffected.
- **Right-to-left text** is only partly supported. Each word is handed to
  the device as one run, so Arabic letters *do* join and shape correctly
  --- but MicroTeX places the words themselves left to right, so a phrase
  of more than one word comes out in the wrong order.
