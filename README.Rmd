...
- Four bundled math fonts: Latin Modern Math, XITS Math, Garamond Math, TeX Gyre DejaVu Math
  - Latin Modern, XITS & Garamond are serif --- pair with `gpar(fontfamily = "serif")`
  - TeX Gyre DejaVu is sans-serif --- pair with `gpar(fontfamily = "sans")`
