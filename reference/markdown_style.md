...
expects: `body` (the document root, which every other tag inherits
from), `p`, `h1` ... `h6`, `ul`, `ol`, `li`, `blockquote`, `pre` (a code
block), `code` (an inline code span), `table`, `hr`, `img`, `div` and
`span`.
...
``` r
markdown_style()
#> <markdown_style> 15 rules, 15 selectors
#>   p            margin-top: 0.55
...
#> <markdown_style> 36 rules, 15 selectors
#>   p            margin-top: 0.8rem
#>   blockquote   margin-top: 0.8rem; padding-left: 1rem; border-left: 0.25rem solid #D1D9E0; color: #59636E
#>   pre          margin-top: 0.8rem; line-height: 1.45; font-family: monospace
#>   table        margin-top: 0.8rem
#>   img          margin-top: 0.55
...
#> <markdown_style> 17 rules, 16 selectors
#>   p            margin-top: 0.55
#>   blockquote   margin-top: 0.55; padding-left: 0.75; border-left: 0.125
#>   pre          margin-top: 0.55; line-height: 1.15; font-family: mono
#>   table        margin-top: 0.55
