...
Render LaTeX math in [**base R** plots](#base-graphics) and as native R
...
typeset by MicroTeX: `main`, `xlab`, `ylab`,
...
on them such as [`hist()`](https://rdrr.io/r/graphics/hist.html).
Nothing else in your plotting code changes. The switch acts at the
device, so it reaches lattice, grid, ggplot2 and other packages’ plot
methods as well: a plain
[`geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.html)
label picks up math without any gridmicrotex function.
...
for it, and showtext overrides it);
...
renders markdown, with `$math$` inline. Unlike the other
...
images — as a stack of grobs. See
...
a device that cannot embed fonts.
...
| [`svglite::svglite()`](https://svglite.r-lib.org/reference/svglite.html) | SVG | [svglite](https://CRAN.R-project.org/package=svglite) |
